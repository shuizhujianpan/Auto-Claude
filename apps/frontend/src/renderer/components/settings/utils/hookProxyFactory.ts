...
export function createHookProxy(
  ...
  return {
    ...
    get showGiteaToken() { return hookRef.current.showGiteaToken; },
    get setShowGiteaToken() { return hookRef.current.setShowGiteaToken; },
    get giteaConnectionStatus() { return hookRef.current.giteaConnectionStatus; },
    get isCheckingGitea() { return hookRef.current.isCheckingGitea; },
